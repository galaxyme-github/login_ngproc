    ...
    <div class="dashboard-container">
        <div class="ngproc-card">
            ...
            <div class="ngproc-card-content">
                ...
                <div class="objetivo-newquot col-md-12"  style="visibility:hidden;position:absolute;">
                    <div class="newquot-title">Seu objetivo é? *</div>
                    <br>
                    <div class="opcoes-newquot">
                        <input type="radio" id="reduzir-cotacao" name="objective" value="1" checked="checked">
                ...
                <div class="buscando-newquot col-md-12"  style="visibility:hidden;position:absolute;">
                    <div class="newquot-title">O que você está buscando? *</div>
                    <br>
                    <div class="opcoes-newquot">
                        <div id="radio1">
                            <input type="radio" id="buscando-produto" name="type" value="0" checked="checked">
                ...
                <!-- COTAÇÕES PRODUTOS -->
                    <div class="form-row" id="form-produto">
                        <div class="col-sm-12">
                            <div class="form-group has-feedback col-md-4">
                                <label for="name">Título *</label>
                                <input type="text" class="form-control" id="title_product" value="<?php if (isset($product_name)) echo $product_name;?>" name="title_product" placeholder="Título da cotação">
                            </div>
                            <div id="opcao" class="form-group has-feedback col-md-4"  style="visibility:hidden;position:absolute;">
                                <label style="font-size: 13px;" id="opcao">Quantas opções de fornecedor*</label>
                                <input type="number" class="form-control" id="provider_qtd_product" value="1" name="provider_qtd_product" placeholder="No máximo 10" min="1" max="10" />
                            </div>

                            <div class="form-group has-feedback col-md-4"  style="visibility:hidden;position:absolute;">
                            <label for="conclusao_prazo">Prazo para conclusão *</label>
                                <input type="text" class="form-control <?php if (!isset($direct_link)) echo 'data data-atual';?>" id="deadline_date_product" name="deadline_date_product" placeholder="dd/mm/aaaa" value="<?php if (isset($direct_link) && $direct_link == '1') echo 'Tempo indeterminado';?>" <?php if (isset($direct_link) && $direct_link == '1') echo 'readonly="readonly"';?> >
                                <label>
                                    <input type="checkbox" id="chkbx-tempo-produto" checked="checked">Tempo indeterminado
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-12"  style="visibility:hidden;position:absolute;">
                            <div class="form-group has-feedback col-sm-5">
                                ...
                                <div >
                                    <label class="radio-inline" style="margin-top: 7px;">
                                        <input class="nacional-checked" type="radio" name="coverage_product" id="coverage_product" value="Nacional" checked="checked"> Nacional
                                    </label>
                            ...
                            <div class="col-sm-5"  style="visibility:hidden;position:absolute;">
                                    ...
                                    <div class="scrollmenu">
                                        ...
                                        <tbody>
                                            <tr id="linha-principal">
                                                <td class="lp-s-1"><input class="form-control cotation_item_name0" type="text" name="cotation_product[cotation_product_items][0][product][item_name]" id="cotation_item_name" placeholder="Produto" required value="<?php if (isset($product_name)) echo $product_name;?>"></td>
                                                <td class="lp-s-1">
                                                    <select class="form-control cat-cotacao0" value="5" style="width:165px;" id="cat-cotacao" name="cotation_product[cotation_product_items][0][product][category_item_prod]" required>
                                                ...
                                                <td class="lp-s-1"><input class="form-control" type="number"  name="cotation_product[cotation_product_items][0][quantity]" id="quantity" min="1" placeholder="Mínimo 1" value="1" required></td>
                                                <td class="lp-s-1"><input class="form-control dinheiro-real" type="text" name="cotation_product[cotation_product_items][0][quote]" id="quote" value="<?php if (isset($valor)) echo $valor;?>" placeholder="R$ 0,00" step="0.01" required></td>
                    ...
                    <!-- COTAÇÕES SERVIÇOS -->
                    <div class="form-row" id="form-servico"  style="visibility:hidden;position:absolute;">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group has-feedback col-sm-6">
                                ...
                                <br>
                                <label class="radio-inline" style="margin-top: 7px;">
                                    <input id="nacional-serv-checked" type="radio" name="coverage_service" id="coverage_service" value="Nacional" checked="checked"> Nacional
                                </label>
                                <label class="radio-inline" style="margin-top: 7px;">
                ...
                <div class= "row" style="display: flex; margin-left: 5px;">
                    ...
                    <div class="col">
                    <input type="submit" class="btn btn-success" id="verde" style="margin-left:20px" value="Adicionar">
                    </div>
                </div>
                <?=$this->Form->end();?>
...
$(document).ready(function(){
    <?php
    if (isset($direct_link) && $direct_link == '1') { 
      echo 'tornarCamposServicosRequeridos(false);';
      echo 'tornarCamposProdutosRequeridos(true);';
      echo 'cotacaoEscolhida = "p";';
      echo '$("#deadline_date_product").val("Tempo indeterminado");';
      echo '$("#deadline_date_product").attr("readonly", true);';
      echo '$("#cat-cotacao option").filter(function() { return $(this).text() == "' . $categoria . '"; }).prop("selected", true);';
    }
    ?>
    $("#buscando-produto").click(function() {
